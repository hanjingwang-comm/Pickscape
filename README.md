...
以下均为作者在本地实际布置的空间截图，展示已保存项目中的客厅、花园和画廊。

### 造境 · 客厅

蓝色沙发、红白边框地毯、包豪斯展示架、复古花架与吧台，把喜欢的物件放在同一个房间。

![作者本地布置：蓝色沙发、展示架、花架与吧台客厅](docs/images/living-room.jpg)

### 造境 · 花园

紫藤、郁金香、虞美人、蜿蜒石路与许愿池，搭配池塘、露营椅和秋千，组成自己的小花园。

![作者本地布置：紫藤、花丛、许愿池、池塘和露营椅花园](docs/images/garden.jpg)

### 造境 · 画廊

猫咪肖像、戴珍珠耳环的少女、彩色双犬与金色骑马雕像，配上奶油色沙发，布置一间私人小画廊。

![作者本地布置：挂画、骑马雕像与奶油沙发画廊](docs/images/gallery.jpg)
